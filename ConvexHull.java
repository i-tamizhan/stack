...
public class ConvexHull {
    ...
    public static void main(String[] args){
        ...
        points[0]=new Point(new GeoPoint(0.0, 3.0));
        points[1]=new Point(new GeoPoint(2.0, 3.0));
        points[2]=new Point(new GeoPoint(1.0, 1.0));
        points[3]=new Point(new GeoPoint(0.0, 1.0));
        points[4]=new Point(new GeoPoint(3.0, 0.0));
        points[5]=new Point(new GeoPoint(0.0, 0.0));
        points[6]=new Point(new GeoPoint(1.0, 1.0));
        //points[6]=new com.iteck.trader.localbusiness.Point(new GeoPoint(15.0, 25.0));
        //points[7]=new com.iteck.trader.localbusiness.Point(new GeoPoint(10.0, 11.0));

        ConvexHull cx = new ConvexHull(points);
